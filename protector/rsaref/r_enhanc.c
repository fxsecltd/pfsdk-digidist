...
int CipherInit (context, encryptionAlgorithm, key, iv, encrypt)
R_ENVELOPE_CTX *context;
 ...
 */
void CipherUpdate (context, output, input, len)
R_ENVELOPE_CTX *context;
